...
struct layers *layers;
{
   ...
   MAXAMORPH=max;  /*otetaan suurimmasta maarasta*/
   DEBUG(MAXAMORPH);
   oflush();
}
...
struct box *box;
{
   ...
   RIC(reccalc->reed,0,"Flag for REED");
...
struct reccalc *reccalc;
{
   ...
   RIC(elstop->correction,0,"Scaled el. density in channels, may improve <110> results.");
